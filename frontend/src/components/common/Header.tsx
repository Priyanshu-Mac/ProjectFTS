...
export const Header: React.FC<HeaderProps> = ({ currentUser, onLogout }) => {
  return (
    <header className="bg-white border-b border-gray-200">
      <div className="relative flex items-center h-16 px-4 sm:px-6"> {/* Added responsive padding */}
        
        {/* --- MODIFIED THIS SECTION FOR RESPONSIVENESS --- */}
        <div className="absolute left-1/2 -translate-x-1/2 flex items-center space-x-1 sm:space-x-3">
          <img 
            src={dtuLogo} 
            alt="DTU Logo" 
            className="h-10 w-10 sm:h-12 sm:w-12" // Responsive logo size
          />
