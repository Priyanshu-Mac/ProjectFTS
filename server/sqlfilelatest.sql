...
\restrict tnPAkiuvXEtcMfhcWA7IljwQMtb0x7O9hb5sGrOXFlfjXKMLByVpGYKYMrXtHq8
...
CREATE TABLE public.files (
    ...
    CONSTRAINT files_priority_check CHECK (((priority)::text = ANY ((ARRAY['Routine'::character varying, 'Urgent'::character varying, 'Critical'::character varying])::text[]))),
...
CREATE TABLE public.sla_policies (
    ...
    CONSTRAINT sla_policies_priority_check CHECK (((priority)::text = ANY ((ARRAY['Routine'::character varying, 'Urgent'::character varying, 'Critical'::character varying])::text[])))
);
...
2	4	1	\N	2	Forward	2025-09-28 05:38:23.237875+00	\N	\N	Initial assignment	\N
\.
...
COPY public.files (id, file_no, subject, notesheet_title, owning_office_id, category_id, priority, date_initiated, date_received_accounts, current_holder_user_id, status, confidentiality, sla_policy_id, created_by, created_at) FROM stdin;
4	ACC-20250928-01	Budget Approval Q4	Q4 Budget Notesheet	1	1	Urgent	2025-09-28	2025-09-28	2	WithOfficer	f	2	1	2025-09-28 05:38:13.809388+00
\.
...
COPY public.sla_policies (id, category_id, priority, sla_minutes) FROM stdin;
1	1	Routine	1440
2	1	Urgent	480
3	1	Critical	240
\.
...
COPY public.users (id, username, name, office_id, role) FROM stdin;
1	clerk1	Clerk One	1	Clerk
2	officer1	Officer One	1	AccountsOfficer
3	cof1	COF One	1	COF
4	admin1	Admin One	1	Admin
\.
...
SELECT pg_catalog.setval('public.file_events_id_seq', 2, true);
...
SELECT pg_catalog.setval('public.sla_policies_id_seq', 3, true);
...
--
-- Name: sla_policies sla_policies_category_id_priority_key; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.sla_policies
    ADD CONSTRAINT sla_policies_category_id_priority_key UNIQUE (category_id, priority);
...
--
-- Name: idx_files_office_category_priority; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_files_office_category_priority ON public.files USING btree (owning_office_id, category_id, priority);
...
\unrestrict tnPAkiuvXEtcMfhcWA7IljwQMtb0x7O9hb5sGrOXFlfjXKMLByVpGYKYMrXtHq8
